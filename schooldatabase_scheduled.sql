...
CREATE TABLE `scheduled` (
  ...
  KEY `fk_scheduled_student_idx` (`studentid`),
  CONSTRAINT `fk_scheduled_room` FOREIGN KEY (`roomid`) REFERENCES `class_room` (`roomid`),
  CONSTRAINT `fk_scheduled_student` FOREIGN KEY (`studentid`) REFERENCES `student` (`studentid`)
