        ...
        <>
          <div className={styles.card}>
            ...
            <div className={styles.section}>
              <h2>Teacher Info</h2>
              <div className={styles.grid}>
                <Info label="Name" value={ipp.teacher.full_name} />
                <Info label="Email" value={ipp.teacher.email} />
                <Info label="Phone" value={ipp.teacher.phone_number} />
                <Info label="Date of Birth" value={ipp.teacher.date_of_birth} />
              </div>
            </div>
